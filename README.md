.. -*- mode: rst -*-
==========================================
 Keyboards for the Central Alaskan Yup'ik language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Central Alaskan Yup'ik language. The data and implementations
...
The Central Alaskan Yup'ik keyboard sources can be acquired using the `Giella SVN
