# Keyboards for Central Alaskan Yup'ik
...
keyboards for the Central Alaskan Yup'ik language. The code
...
The Central Alaskan Yup'ik keyboard sources can be acquired using the Fork or Code
